...
L’udito amplifica suoni deboli (spostamenti ~10^{-18} m) attraverso l’active process nelle cellule ciliate cocleari. **Coerenza quantistica** in bundle stereocilia (actina + microtubuli) genera otoacoustic emissions – vibrazioni coerenti che amplificano segnale. **Tunneling protonico** in canali Piezo1/2 permette gating meccanocettivo rapido – sensibilità a frequenze alte. Evidenze 2025: modelli quantum migliorano spiegazione discriminazione frequenze (review J. Acoust. Soc. Am. 2025).
